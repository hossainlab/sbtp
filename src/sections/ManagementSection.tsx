      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold mb-4 text-white tracking-tight">
            Our <span className="text-blue-400">Management Team</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {MANAGEMENT.map((member) => (
            <div
              key={member.id}
              className="group glass rounded-3xl overflow-hidden border-slate-800 hover:border-blue-500/50 transition-all duration-500 hover:-translate-y-2 bg-slate-950/60"
            >
              {/* Image */}
